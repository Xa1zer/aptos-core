...
use crate::{change_set::ChangeSet, pruner::*, state_store::StateStore, AptosDB, ResourceKey};
...
fn test_state_store_pruner() {
    ...
    // Prune till version=2.
    {
        ...
        // root1 is gone.
        assert!(state_store
            .get_value_with_proof_by_version(ResourceKey::AccountAddressKey(address), 1)
            .is_err());
