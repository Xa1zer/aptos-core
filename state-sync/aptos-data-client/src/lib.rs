...
pub trait AptosDataClient {
    ...
    ) -> Result<Response<StateStoreValueChunkWithProof>>;
...
impl From<StateStoreValueChunkWithProof> for ResponsePayload {
    fn from(inner: StateStoreValueChunkWithProof) -> Self {
