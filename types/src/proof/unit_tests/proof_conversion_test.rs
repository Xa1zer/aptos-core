...
use crate::{
    ...
    proof::{
        definition::{
            EventProof, ResourceValueProof, TransactionInfoListWithProof, TransactionInfoWithProof,
        },
...
proptest! {
    ...
    #[test]
    fn test_account_state_proof_bcs_roundtrip(proof in any::<ResourceValueProof>()) {
        assert_canonical_encode_decode(proof);
    }
